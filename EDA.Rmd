...
You can find the dataset here:[UCI Wine Quality Data Set](https://archive.ics.uci.edu/ml/datasets/wine+quality). We also hosted some of the dataset  in our local github repository at [Exploratory_data_analysis](https://github.com/otienomaurice1/Exploratory_Data_Analysis.git) and can be downloaded as required.
...
# Updated URLs from the new repo (must use raw format)
url <- "https://raw.githubusercontent.com/otienomaurice1/Exploratory_Data_Analysis/main/winequality-red.csv"
red_wine <- read.csv(url, sep = ";")

url_white <- "https://raw.githubusercontent.com/otienomaurice1/Exploratory_Data_Analysis/main/winequality-white.csv"
